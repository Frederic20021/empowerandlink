      ...
      <div className="max-w-[1080px] mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            >
              {t.ict.notionSection.title.split('\n').map((line, i) => (
                <span key={i}>
                  {line}
                  {i < t.ict.notionSection.title.split('\n').length - 1 && (
                    <br />
                  )}
                </span>
              ))}
            ...
            <p className="text-[15px] text-slate-600 leading-[1.9] mb-7">
              {t.ict.notionSection.description.split('\n').map((line, i) => (
                <span key={i}>
                  {line}
                  {i < t.ict.notionSection.description.split('\n').length - 1 && (
                    <br />
                  )}
                </span>
              ))}
            ...
            <ul className="grid grid-cols-2 gap-x-4 gap-y-2.5 list-none mb-8">
              {t.ict.notionSection.features.map((f) => (
                <li
                  key={f}
