        ...
        >
          ...
          <div className="relative z-10">
            ...
            >
              ...
              40,000
              <sub className="text-[0.28em] font-semibold text-slate-600">
                {t.notion.basicPlan.priceSub}
              </sub>
            </div>
            <p className="text-slate-600 text-sm mt-2 mb-8">
              {t.notion.basicPlan.includesNote}
            </p>
            <p className="text-base font-bold text-slate-900 mb-5">
              {t.notion.basicPlan.includesLabel}
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-left mt-2">
              {t.notion.basicPlan.includes.map((item) => (
                <div
                  key={item}
