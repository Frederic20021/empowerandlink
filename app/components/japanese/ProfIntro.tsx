...
const ProfIntro = () => {
    ...
    >
      ...
      <div className="md:p-4 gap-12 md:gap-8 grid md:grid-cols-2 mx-auto items-stretch ">
        {ProfInfo.map((prof) => (
          <div
            key={prof.id}
            className="flex flex-col mx-auto bg-white p-2 md:p-4 h-full hover:translate-y-[-30px] transition-transform duration-500 cursor-pointer"
        ...
        <div className="flex gap-4 mx-auto text-xs md:text-base my-4">
          <div className="flex justify-center items-center">
            <Link
              href="https://empowerandlink.com/contact"
              className="border-red-700 bg-white border-2 hover:bg-red-700 text-red-700 hover:text-white px-3 sm:px-4 py-2 sm:py-3 md:py-4 font-bold rounded-lg transition-colors duration-300 shadow-lg"
            >
              お問い合わせ
            </Link>
          </div>
          <div className="flex justify-center items-center">
            <Link
              href="https://empowerandlink.com/contact"
              className="border-red-700 bg-red-600 text-white border-2 hover:bg-white hover:text-red-700 px-3 sm:px-4 py-2 sm:py-3 md:py-4 font-bold rounded-lg transition-colors duration-300 shadow-lg"
            >
              無料体験お試し(申し込む)
            </Link>
          </div>
